...
public class SimpleCookieManager implements CookieJar {
    ...
    private final static String COOKIE_MANAGER_PREFIX = "    [Cookie Manager] ---> ";
    ...
    public List<Cookie> loadForRequest(@NotNull HttpUrl httpUrl) {
        ...
        sb.append(COOKIE_MANAGER_PREFIX).append("Fetching cookies for domain: [").append(host).append("]...");
    ...
    public void saveFromResponse(@NotNull HttpUrl httpUrl, @NotNull List<Cookie> responseCookies) {
        ...
        synchronized (this) {
            ...
            responseCookies
                    ...
                    .forEach(cookie -> {
                        logData.accept(COOKIE_MANAGER_PREFIX + "Storing cookie [" + cookie.name() + "] --> [" + cookie.value() + "]");
